...
from ts_benchmark.utils.get_file_name import build_output_file_stem
...
def get_output_stem(args: argparse.Namespace) -> str:
    model_name = args.model_name[0].split(".")[-1] if args.model_name else "model"
    if args.data_name_list:
        dataset_name = args.data_name_list[0]
    elif args.data_set_name:
        dataset_name = args.data_set_name[0]
    else:
        dataset_name = "dataset"
    return build_output_file_stem(model_name, dataset_name)
...
if __name__ == "__main__":
    ...
    if args.report_method == "csv":
        leaderboard_file_name = get_output_stem(args) + "_report.csv"
